                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item" href="">Surat Pengajuan : 
                                                <a href="<?= base_url("magang/download_surat/".$get['surat']); ?>"><?= $get['surat']; ?></a></li>
                                            <li class="list-group-item">Portofolio : 
                                                <a href="<?= base_url("magang/download_portofolio/".$get['portofolio']); ?>"><?= $get['portofolio']; ?></a></li>
                                        </ul>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $tgs['deskripsi']; ?></td>
                                        <td><?= $tgs['file_tgs']; ?></td>
                                        <td><a class="btn btn-primary me-1 mb-1" href="<?= base_url("magang/download/".$tgs['file_tgs']); ?>">Download</a> </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
