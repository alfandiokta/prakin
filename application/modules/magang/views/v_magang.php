                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $mg['wa']; ?></td>
                                        <td><?= $mg['keahlian']; ?></td>
                                        <td><a class="btn btn-primary me-1 mb-1" href="<?= base_url(); ?>magang/detail/<?= $mg['id']?>">Detail</a>
                                            <a class="btn btn-danger me-1 mb-1" href="<?= base_url('magang/update_data/' . $mg['id']); ?>" >Selesai</a>
                                            <?php 
                                         $wa=$mg['wa'];
                                         $nama=$mg['nama'];
                                         ?>
