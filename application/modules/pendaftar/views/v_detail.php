                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Data Pendaftar Magang</p>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item" href="">Surat Pengajuan : 
                                                <a href="<?= base_url("pendaftar/download_surat/".$get['surat']); ?>"><?= $get['surat']; ?></a></li>
                                            <li class="list-group-item">Portofolio : 
                                                <a href="<?= base_url("pendaftar/download_portfolio/".$get['portofolio']); ?>"><?= $get['portofolio']; ?></a></li>
                                        </ul>
                                    </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img  width="100px"src="<?= base_url('assets/doc/img_absen/'.$absn['foto_aktivitas']); ?>"></td>
                                        <td><img  width="100px"src="<?= base_url('assets/doc/ttd/'.$absn['ttd']); ?>"></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $tgs['deskripsi']; ?></td>
                                        <td><?= $tgs['file_tgs']; ?></td>
                                        <td><a class="btn btn-primary me-1 mb-1" href="<?= base_url("pendaftar/download/".$tgs['file_tgs']); ?>">Download</a> </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
